...
Namespace WpfPivotGridConditionalFormatting
    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class SalesPersonDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddSalesPersonRow(ByVal Country As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal Quantity As Short, ByVal Extended_Price As Decimal, ByVal Sales_Person As String, ByVal OrderDate As Date) As SalesPersonRow
                Dim rowSalesPersonRow As SalesPersonRow = (DirectCast(Me.NewRow(), SalesPersonRow))
                Dim columnValuesArray() As Object = { Country, ProductName, CategoryName, Quantity, Extended_Price, Sales_Person, OrderDate}
    ...
    End Class
End Namespace
Namespace WpfPivotGridConditionalFormatting.nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Country, ProductName, CategoryName, Quantity, [Extended Price], [Sa" & "les Person], OrderDate" & ControlChars.CrLf & "FROM            SalesPerson"
